## GoStack Desafio 04 -  Introdução ao React
...
O layout não precisa ficar exatamente igual ao feed do facebook, você pode utilizar sua criatividade para modificar da maneira que preferir.
